        ...
        <div class="px-4 sm:px-6 lg:px-8 bg-white pt-4">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Vendor Management</h1>
                    <p class="mt-2 text-sm text-gray-700">
                        A list of all the product Vendor's in your account including their name, slug and actions.
                    </p>
                </div>
